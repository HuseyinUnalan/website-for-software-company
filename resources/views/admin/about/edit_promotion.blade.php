...
@section('admin')
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Tanıtım Yazısı Düzenle</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Hakkımızda İşlemleri</a></li>
                                <li class="breadcrumb-item active">Tanıtım Yazısı Düzenle</li>
                            </ol>
                        </div>
            ...
            <form action="{{ route('update.promotion.text') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <input type="hidden" name="old_image" value="{{ $promotion->photo }}">

                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label"></label>
                                    <div class="col-sm-10">
                                        <img id="showImage" class="rounded avatar-xl" style="width: 150px; height: auto;"
                                            src="{{ !empty($promotion->photo) ? url($promotion->photo) : url('upload/no_image.jpg') }}">
                                    </div>
                                </div>
                                <!-- end row -->
                                ...
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Tanıtım Yazısı</label>
                                    <div class="col-sm-10">
                                        <textarea id="elm1" name="description">{{ $promotion->description }}</textarea>
                                    </div>
                                </div>
                                <!-- end row -->
